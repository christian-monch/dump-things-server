...
# CM: add
# + if self.namespaces.uri_for(cls.class_uri) == URIRef('https://w3id.org/linkml/Any'): ---
#
# or add:
#
# +
...
class Generator(metaclass=abc.ABCMeta):
    ...
    def is_any(self, cls: Union[ClassDefinition, TypeDefinition]) -> bool:
        return self.namespaces.uri_for(cls.class_uri) == URIRef('https://w3id.org/linkml/Any')
